...
The History of portable computing has been a vast and important journey for computing as there has been a plethora of major advances that have paved paths for later devices. Started off with one of the first major developments is the IBM 5100, it was one of the earliest portable computers, combining a processor, keyboard, monitor, and tape drive into a single unit that was portable. Then comes the Obsorne 1, which was the first comercially successful portable ocmputer that made its name by being portablly pluggable allowing busniness to work on the go coming with its own keyboard, screen, storage and software that was worth almost the entire price of computer itself.
